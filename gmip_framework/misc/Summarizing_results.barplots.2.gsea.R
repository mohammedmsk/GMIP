...
data=data[data$ID=="GoldStandard"]

# Create directory for barplots if it doesn't exist
if (!dir.exists("barplots_gsea_GS")) {
  dir.create("barplots_gsea_GS")
}
...
generate_combined_barplot_per_gwas <- function(gwas) {
  ...
  ggsave(filename = paste0("barplots_gsea_GS/", gwas, "_combined_barplot_all_strategies.png"), 
